...
// function yearsUntlRetirement(year, firstName) {
...
// yearsUntlRetirement(1990, 'John');
// yearsUntlRetirement(1948, 'Mike');
// yearsUntlRetirement(1969, 'Jane');

/****************************************
 * Runction Statement and Expressions
 */
...
var john = {
  ...
  calcTips: function() {
    ...
    for (var i = 0; i < this.bills.length; i++) {
      // Determie percentage based on tipping rules
      var percentage;
      ...
      this.finalPrice[i] = bill + bill * percentage;
    }
  }
}
...
if (john.average > mark.average) {
  console.log(john.fullName + '\'s family paid higher tips, with the average being $' + john.average);
} else if (mark.average > john.average) {
  console.log(mark.fullName + '\'s family paid higher tips, with the average being $' + mark.average);
} else {
  console.log('They paid the same on average');
}
